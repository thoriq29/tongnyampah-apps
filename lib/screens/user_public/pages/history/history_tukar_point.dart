...
class HistoryTukarPoint extends StatefulWidget {
  HistoryTukarPoint({this.userUID});

  final String userUID;
  @override
  _HistoryTukarPointState createState() => _HistoryTukarPointState();
}

class _HistoryTukarPointState extends State<HistoryTukarPoint> {
  @override
  void dispose() {
    super.dispose();
  }
      ...
      body: Container(
        child: StreamBuilder(
          stream: _firestore
              ...
              .where('type', isEqualTo: 'tukar_point')
