...
class HistoryLaporkanTukangNyampah extends StatefulWidget {
  HistoryLaporkanTukangNyampah({this.userUID});

  final String userUID;
  @override
  _HistoryLaporkanTukangNyampah createState() =>
      _HistoryLaporkanTukangNyampah();
}

class _HistoryLaporkanTukangNyampah
    extends State<HistoryLaporkanTukangNyampah> {
  @override
  void dispose() {
    super.dispose();
  }
      ...
      body: Container(
        child: StreamBuilder(
          stream: _firestore
              ...
              .where('type', isEqualTo: 'foto_tukang_nyampah')
