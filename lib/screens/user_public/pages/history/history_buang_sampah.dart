...
class HistoryBuangSampah extends StatefulWidget {
  HistoryBuangSampah({this.userUID});

  final String userUID;
  @override
  _HistoryBuangSampah createState() => _HistoryBuangSampah();
}

class _HistoryBuangSampah extends State<HistoryBuangSampah> {
  @override
  void dispose() {
    super.dispose();
  }
      ...
      body: Container(
        child: StreamBuilder(
          stream: _firestore
              ...
              .where('type', isEqualTo: 'foto_buang_sampah')
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          if (snapshot.hasData) {
            if (snapshot.data.documents.length == 0) {
              return TongsWidget.noData(
                title: 'Belum ada pemberitahuan',
                subtitle: 'Tidak ada data yang menunggu verifikasi oleh admin',
              );
            }
            return ListView(
              padding: EdgeInsets.all(15),
                      ...
                      Container(
                        ...
                        child: Row(
                          children: <Widget>[
                            Expanded(
                              child: Text(
                                docs['point_defference'].toString() + ' Point',
                                style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  color: ThemeApp.bluePrimary,
                                  fontSize: 13,
